...
Six workstreams run concurrently with (not inside) the currently-active macro-phase and must not be forgotten when the rebuild banner is lifted:
...
*End of CLAUDE.md v2.8 (amended 2026-05-20 — Wave 1 wrap-up seal: Conductor as 6th concurrent workstream confirmed; post-Wave-1 close 2026-05-20; split-PR procedure initiated). Prior: v2.7 (2026-05-20 §E — Conductor workstream added as sixth concurrent workstream; "Five workstreams" → "Six workstreams"; Phase 4C status updated to WAVE_1_COMPLETE_PENDING_PR; applied in 4C-9 Wave 1 close session in anticipation of cherry-pick PR). v2.6 (2026-05-19 §E — Phase 4C Panchang workstream added; "Four workstreams" → "Five workstreams"; Phase 4C entry ACTIVE, 4C-0 sealed). v2.5 (2026-05-18 §M.17 — Chat V2 Big Bang COMPLETE; sealing-merge `6c431f9` PR #82). v2.4 (2026-05-13 M5 opened); v2.3 (Gate II.5 close); v2.2 (Pipeline-Transform-S1 close); v2.1 (Phase 11B). Governance rebuild closed; M4 CLOSED 2026-05-02; M5 ACTIVE — M5-A is the active sub-phase.*
