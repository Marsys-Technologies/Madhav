...
| LEL | `01_FACTS_LAYER/LIFE_EVENT_LOG_v1_2.md` | 1.6 | CURRENT |
...
Eleven workstreams run concurrently with (not inside) the currently-active macro-phase and must not be forgotten when the rebuild banner is lifted:
