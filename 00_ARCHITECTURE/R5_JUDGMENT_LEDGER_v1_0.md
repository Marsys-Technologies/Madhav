...
lane), JL-005 (W0b-codegen lane), JL-006 (W1 address-resolver lane), JL-007 (W1 chart_query lane),
  ...
  (W1 Ring-1 reconciliation, r5/w1-reconcile), JL-011 (W2 paradigm-facet lane, r5/w2-paradigm-facet
  — number may collide with a sibling W2 lane's own JL-011; renumber at Ring-1 if so) recorded
created: 2026-07-08
...
### JL-011 — W2 paradigm-facet lane: paradigm vocabulary scope, query_signals default-filter behavior, and the concrete backing for kp/tajika addressing
