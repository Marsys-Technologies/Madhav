...
### JL-019 — W4 session-pin lane: what "session pin" means per the design; the phantom `builds` table vs. the live `build_runs` table; and the scope boundary against full envelope build_id propagation
