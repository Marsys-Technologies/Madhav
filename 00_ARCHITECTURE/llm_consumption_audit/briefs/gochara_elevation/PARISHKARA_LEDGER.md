...
|---|---|---|---|
| MR-01 | Schema parity (8 cols) → tools un-500 | QUEUED | — |
| MR-02 | Coverage gate authority-aware | QUEUED | — |
| MR-03 | Truthful '3.0' citation | QUEUED | — |
| MR-04 | Valence vocabulary contract | QUEUED | — |
| MR-05 | Corrected deprecation migration (FK-safe) | QUEUED | — |
| MR-06 | Seed/542 durability + gen-3.0 protection | QUEUED | — |
| MR-07 | Cockpit truth (count_sql) | QUEUED | — |
| MR-08 | Flip/rollback/probe tooling | QUEUED | — |
| MR-09 | Naming coherence + health + pointers | QUEUED | — |
| MR-10 | Promote 54 point rows | QUEUED | — |
...
| MR-14 | term_breakdown → rebuild → refit | QUEUED | — |
...
| MR-18 | Validators generation stance | QUEUED | — |
...
| MR-25 | Citations resolve in serving | QUEUED | — |
...
| MR-30 | Hygiene (w61 scripts FIRST, worktrees, docstrings) | QUEUED | — |
...
| MR-34 | Third-chart scope statement | QUEUED | — |
| MR-35 | Serving-outage smoke probe (CI) | QUEUED | — |
