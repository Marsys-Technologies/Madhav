...
| W2.8 | 2 | [mech] | Bhava targets get degrees | PASS | gochara3/w28 | /Users/Dev/Vibe-Coding/Apps/Madhav/utk-w28 | sonnet | W1.1 PASS | PR #1166 CI PASS (19/19 non-deploy); armed ("already queued"). VERIFIER PASS: bhava_cusps L1-ref discipline. |
| W2.9 | 2 | [mech] | Citation resolution table | PASS | gochara3/w29 | /Users/Dev/Vibe-Coding/Apps/Madhav/utk-w29 | sonnet | W1.1 PASS | PR #1167 CI PASS (19/19 non-deploy); armed ("already queued"). VERIFIER PASS: all 3 citation sources cataloged. |
...
| W3.3 | 3 | [heavy] | Multi-resolution hierarchy | PASS | gochara3/w33 | /Users/Dev/Vibe-Coding/Apps/utk-w33 | sonnet | W3.2 PASS | PR #1170 in readonly merge queue. VERIFIER PASS (opus, a86c06b1): 10/10 AC — RESOLUTION_TIERS order, WindowResolutionRecord, assign_parent (widest-wins pure), era/month/day builders, build_resolution_hierarchy, I2 clean, 15 tests. |
| W3.4 | 3 | [heavy] | Century horizon + slice receipts | BUILDING | gochara3/w34 | /Users/Dev/Vibe-Coding/Apps/utk-w34 | sonnet | W0.3 PASS + W3.2 PASS | PR #1171 open (4793ad482, 733+808 insertions). §N.8 fix committed (f31e319dd): fallback_used now derived from real fetch_base_rate_for_class DB lookup. CI re-running (run 31364456081). |
...
- 2026-08-10 12:30 IST: SESSION 12 (context-compact continuation). Immediate task: W3.4 CI §N.8 failure on PR #1171. Root-cause: `fallback_used=True` literal constant in ThresholdConfig construction at line 582 of ka_gochara_v3_century_materialize.py — no program input could change it, violating §N.8. Fix: imported `fetch_base_rate_for_class` from `services.gochara_v3.threshold`; derived `(base_rate_cited, age_band_used, fallback_used)` from a real DB lookup before constructing ThresholdConfig; `lambda_thresh=0.0` structural-prior design preserved. Local earned-signal lint: PASS (0 new violations). Commit f31e319dd pushed to gochara3/w34. New CI run 31364456081 triggered on PR #1171. W3.4 lane table updated: BUILDING → CI RUNNING (fix in flight). W3.3 still in merge queue (head-of-queue). W3.4 lane: BUILDING (CI re-running after §N.8 fix).
