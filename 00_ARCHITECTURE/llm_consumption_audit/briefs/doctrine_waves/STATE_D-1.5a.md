...
lanes:
  - {lane: A-0, branch: wave/D-1.5a/A-0, status: claimed, receipt_ref: null, agent_id: a1d4e2a584592cf56, commit: b1b086bb, claim: "harness at platform/scripts/audit/doctrine_harness/, CLI contract validated live; canonical baseline reproduced EXACT (reds 1-5,7-9,11; greens 10,12; #6 split); A6 items done (SESSION_LOG, DIS.015/DR-2, CURRENT_STATE, ONGOING_HYGIENE); scope clean vs fork point 4bebb622; flagged Bearer-credential 401 in sandbox as followup"}
