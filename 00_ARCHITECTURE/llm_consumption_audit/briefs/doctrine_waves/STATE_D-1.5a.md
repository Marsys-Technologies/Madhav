...
gate: {run: true, green: [1,5,6a,8,9,10,12,A5], red: [2,3,4,6b,7,11,A7], note: "2nd gate run (post-#564 deploy): #8(career) now green, #7(wealth) still red -- 3rd chained bug found: bearing_yogas kept top-3-by-strength not domain-matching entries, so Dhana Yoga still missing despite verdict scoring it correctly. Hotfix PR #565 (domain-match sort, commit 0e79a643) RECEIPTED ACCEPT, CI running. Re-run full gate after merge+deploy."}
