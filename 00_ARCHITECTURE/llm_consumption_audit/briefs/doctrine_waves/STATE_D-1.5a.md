...
gate: {run: true, green: [1,5,6a,9,10,12,A5], red: [2,3,4,6b,7,8,11,A7], note: "first live gate run found #7 red. hardFloor hotfix PR #564 MERGED (53b4b44c), watching CI+deploy. Re-run full gate battery once live SHA confirmed."}
