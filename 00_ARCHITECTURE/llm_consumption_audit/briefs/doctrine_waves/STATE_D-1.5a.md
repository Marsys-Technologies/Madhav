...
gate: {run: true, green: [1,5,6a,9,10,12,A5], red: [2,3,4,6b,7,8,11,A7], note: "first live gate run: #7 red due to response-budget hard-cap trimmer zeroing bearing_yogas. hardFloor hotfix RECEIPTED ACCEPT (verifier af8e55650478692fc, rigorous shared-infra review), PR #564 open, CI running. Also found+corrected a 2nd unauthorized-attribution commit (55209dd1, same pattern as e8fba6ed) -- content kept (independently corroborated), provenance flagged. Re-run gate after PR #564 merges+deploys."}
