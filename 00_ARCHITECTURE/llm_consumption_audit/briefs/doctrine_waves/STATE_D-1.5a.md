...
gate: {run: true, green: [1,5,6a,8,9,10,12,A5], red: [2,3,4,6b,7,11,A7], note: "PR #565 (domain-match sort) MERGED (b687339b), watching CI+deploy. Re-run full gate battery once live SHA confirmed -- this should finally resolve #7."}
