...
lanes:
  ...
  - {lane: V-4, branch: worktree-agent-a2a7ae8a7815fc407, status: verifying, cycle: 1, worktree_base: d349a9c3, base_stale: true, verifier_dispatched: a874172c0e41c75af, note: "CR-24 honest negative (no 10->8->12->10 circuit on real chart, serves convergent_dispositor_chain instead); CR-78 bo_anveshana PARKED (3 live dependents found); PARK-#4 real pop=43408/49360, reclaim count post-rebuild-only"}
  ...
  - {lane: V-6, branch: wave/D-2/V-6 (self-rebased by implementer), status: rejected(1), cycle: 1, worktree_base: fdc99de1, base_stale: false, verifier_receipt: "REJECT attempt 1/3 - doctrine substance ALL SOUND (kendradhipati PROPOSED-marking safety property verified PASS), rejection is narrow: 4 stale test-constant regressions (SYSTEMS 7->8, dasha-plan substeps 36->41, bespoke-detector set +12 kala_sarpa variants) + implementer's self-reported test counts were materially false. Respawned same worktree/branch with exact diagnosis."}
