...
lanes:
  ...
  - {lane: V-6, branch: wave/D-2/V-6 (self-rebased by implementer), status: verifying, cycle: 1, worktree_base: fdc99de1, base_stale: false, verifier_dispatched: a082c6ffd311a1286, note: "kendradhipati-dosha rows marked doctrine_status=PROPOSED pending conductor DR-record (protocol §4.3 compliant, not self-adjudicated); migrations 455-459 unused (no DDL needed, verified live); CR-73 partial (Manglik+12 Kala-Sarpa variants bespoke, ~15 catalog doshas honest fallthrough)"}
