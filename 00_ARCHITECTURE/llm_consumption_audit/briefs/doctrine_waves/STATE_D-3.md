...
gate: {run: false, blocker: "REGRESSION GUARD RED on judgment_query(wealth) — composite_score 2.38 vs baseline ~2.78, verdict_grade convergent_moderate vs convergent_strong. Dhana Yoga presence unaffected. Root cause NOT investigated (no fix-loop). Wave does not proceed to full §G gate battery until this is dispositioned."}
updated_at: "2026-07-18T02:45+05:30"
resumed_at: null
