...
lanes:
  ...
  - {lane: B-5, branch: wave/D-1.5b/B-5, status: claimed, agent_id: a0e2585e962da68fa, commit: d0a176ca, claim: "CR-17 karakamsa already emitted (regression-locked, no dup fabricated); CR-18 shadbala ratio key added (required_rupa pre-existed) + CHART_FACTS_SCHEMA.json allowed_keys; CR-58 new varga_hora_class category (D2, no CHECK/migration needed, count_sql already covers); CR-46 ph_nimitta writer-level anchor dedup. 10 tests, full suite 3371/0. NO migration. Scope clean (5 files in may_touch). Follow-up: optional ga_vargas target_floor re-baseline."}
  ...
  - {lane: B-1, branch: wave/D-1.5b/B-1, status: claimed, agent_id: ad8c83defdb551e7b, commit: 44ec371a, base: 68bb0246, claim: "HEADLINE done: compute_bhava_chalit() in houses.py (Sripati bhaava_madhya_sripathi + Placidus bhaava_madhya_swe, local-time JD). Moon->Sripati-H12 sandhi specimen REPRODUCES (Sripati H12 arc [322.696,355.846], Moon 327.06 inside; lagna 12.42 Aries FORENSIC-ok). New facts bhava_cusps/house_chalit/sandhi_flag (additive, orb 3deg). BOTH fake-cusp sites replaced with real Placidus + REAL 249-div sub-lord (was trivially derivable, no EXTERNAL needed). Whole-sign house_d1 UNTOUCHED. 14 tests, full suite 3375/0. NO migration. Follow-up: count_sql/serving wiring for new categories (later-lane consumer surfaces)."}
