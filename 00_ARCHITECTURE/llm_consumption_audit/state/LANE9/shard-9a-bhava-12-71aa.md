# Lane 9a STRUCTURAL shard — bhava:12:71aa

node_key: bhava:12:71aa
node_id: 5b43a4ce-2302-4424-be99-4d98ce64949f
...
WITH nbr AS (SELECT e.edge_id,e.edge_type,e.from_node_id,e.to_node_id,e.citation_ref,e.underlying_msr_signal_ids_array
  ...
  WHERE e.chart_id='482012f1-710e-4a25-994a-93821f5871aa'
    AND (e.from_node_id='5b43a4ce-2302-4424-be99-4d98ce64949f'::uuid OR e.to_node_id='5b43a4ce-2302-4424-be99-4d98ce64949f'::uuid))
...
Node existence CONFIRMED in bodha_cgm_nodes (node_type='bhava', node_subject='12').
...
## Findings
[F1] class=1 UNREACHABLE (severity=high). Bhava-12 node is fully isolated: 0 edges.
