# Lane 9a STRUCTURAL shard — node_key `bhava:10:f75a`

- node_id: `311b304c-8e75-42fe-b49e-a75377ca1cbe`
- node_type: `bhava`  node_subject: `10`
...
WITH nbr AS (
  ...
  WHERE e.chart_id='1c826d5a-41cb-4450-b4dc-59d440e5f75a'
    AND (e.from_node_id='311b304c-8e75-42fe-b49e-a75377ca1cbe' OR e.to_node_id='311b304c-8e75-42fe-b49e-a75377ca1cbe'))
...
node 311b304c-8e75-42fe-b49e-a75377ca1cbe exists in bodha_cgm_nodes  ->  1 (chart …f75a, node_type=bhava, node_subject=10)
edges touching 311b304c-8e75-42fe-b49e-a75377ca1cbe (any chart)      ->  0
```
...
- summary: bhava `10` exists as a first-class CGM node but participates in ZERO edges; no dispositor / lordship / yoga / temporal relationship is reachable from or to it via graph walk.
