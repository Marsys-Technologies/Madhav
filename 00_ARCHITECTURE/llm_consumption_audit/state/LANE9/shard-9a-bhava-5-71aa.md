# Lane 9a STRUCTURAL shard — bhava:5:71aa

node_key: bhava:5:71aa
node_id: 4c9d34e0-e04e-45ab-b1d5-65194af91558
node_type: bhava   node_subject: 5
...
WITH nbr AS (SELECT e.edge_id,e.edge_type,e.from_node_id,e.to_node_id,e.citation_ref,e.underlying_msr_signal_ids_array
  ...
  WHERE e.chart_id='482012f1-710e-4a25-994a-93821f5871aa'
    AND (e.from_node_id='4c9d34e0-e04e-45ab-b1d5-65194af91558'::uuid OR e.to_node_id='4c9d34e0-e04e-45ab-b1d5-65194af91558'::uuid))
...
Node existence CONFIRMED in bodha_cgm_nodes (node_type='bhava', node_subject='5').
...
## Findings
[F1] class=1 UNREACHABLE (severity=high). Bhava-5 node is fully isolated: 0 edges.
