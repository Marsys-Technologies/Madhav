# shard-9b-panchanga_yamakantaka

Lane: 9b. Charts: A=482012f1, B=1c826d5a.

## Exact SQL run
5-cell recipe (charter §4) with `<CAT>`=`panchanga_yamakantaka` + chart_facts count + fan-out probe.
...
- F2 (class 2 WRONG, LOW): yamakantaka (inauspicious upagraha time-segment) mapped to `character|spirituality` identically to 4 sibling categories — default-domain mis-map.
