# shard-9b-graha_vimsopaka_shadvarga

Lane: 9b MSR ingestion. Charts: Abhisek `482012f1`, Abhinandan `1c826d5a`.

## Reproducible call
9b 5-cell recipe with `<CAT>='graha_vimsopaka_shadvarga'`. chart_facts denominator: **35 / 35**.
...
Identical profile to the other vimsopaka schemes: fully attributed, salience maximally inflated (100% major on 482012f1), uniform domain, one of four redundant schemes.

## Findings
- **F1 (class 7 DROWNED, HIGH):** 100% major on 482012f1 (35/35) for a shadvarga dignity average. Evidence: cell2_salience 482012f1="major=35".
- **F2 (class 7 DROWNED, HIGH — cross-category):** four-scheme vimsopaka redundancy wall. Flag for conductor merge.
