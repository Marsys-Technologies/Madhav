# Lane 9a STRUCTURAL shard — node_key `bhava:11:f75a`

- node_id: `0ab37132-e86d-4d79-937b-56bb083b75bf`
- node_type: `bhava`  node_subject: `11`
...
WITH nbr AS (
  ...
  WHERE e.chart_id='1c826d5a-41cb-4450-b4dc-59d440e5f75a'
    AND (e.from_node_id='0ab37132-e86d-4d79-937b-56bb083b75bf' OR e.to_node_id='0ab37132-e86d-4d79-937b-56bb083b75bf'))
...
node 0ab37132-e86d-4d79-937b-56bb083b75bf exists in bodha_cgm_nodes  ->  1 (chart …f75a, node_type=bhava, node_subject=11)
edges touching 0ab37132-e86d-4d79-937b-56bb083b75bf (any chart)      ->  0
```
...
- summary: bhava `11` exists as a first-class CGM node but participates in ZERO edges; no dispositor / lordship / yoga / temporal relationship is reachable from or to it via graph walk.
