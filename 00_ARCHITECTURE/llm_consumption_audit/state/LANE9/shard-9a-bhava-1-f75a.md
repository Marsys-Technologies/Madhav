# Lane 9a STRUCTURAL shard — node_key `bhava:1:f75a`

- node_id: `a3307634-fe48-4539-be05-5639554dbe13`
- node_type: `bhava`  node_subject: `1`
...
WITH nbr AS (
  ...
  WHERE e.chart_id='1c826d5a-41cb-4450-b4dc-59d440e5f75a'
    AND (e.from_node_id='a3307634-fe48-4539-be05-5639554dbe13' OR e.to_node_id='a3307634-fe48-4539-be05-5639554dbe13'))
...
node a3307634-fe48-4539-be05-5639554dbe13 exists in bodha_cgm_nodes  ->  1 (chart …f75a, node_type=bhava, node_subject=1)
edges touching a3307634-fe48-4539-be05-5639554dbe13 (any chart)      ->  0
```
...
- summary: bhava `1` exists as a first-class CGM node but participates in ZERO edges; no dispositor / lordship / yoga / temporal relationship is reachable from or to it via graph walk.
