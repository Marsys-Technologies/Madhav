# Lane 9a STRUCTURAL shard — bhava:6:71aa

node_key: bhava:6:71aa
node_id: b3d6b858-b4c9-4a9b-a202-279ea68cf5a0
node_type: bhava   node_subject: 6
...
WITH nbr AS (SELECT e.edge_id,e.edge_type,e.from_node_id,e.to_node_id,e.citation_ref,e.underlying_msr_signal_ids_array
  ...
  WHERE e.chart_id='482012f1-710e-4a25-994a-93821f5871aa'
    AND (e.from_node_id='b3d6b858-b4c9-4a9b-a202-279ea68cf5a0'::uuid OR e.to_node_id='b3d6b858-b4c9-4a9b-a202-279ea68cf5a0'::uuid))
...
Node existence CONFIRMED in bodha_cgm_nodes (node_type='bhava', node_subject='6').
...
## Findings
[F1] class=1 UNREACHABLE (severity=high). Bhava-6 node is fully isolated: 0 edges.
