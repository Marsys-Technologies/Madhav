# Lane 9a STRUCTURAL shard — bhava:4:71aa

node_key: bhava:4:71aa
node_id: f04893fd-d9b0-407f-a5dc-b48a9360dba7
...
WITH nbr AS (SELECT e.edge_id,e.edge_type,e.from_node_id,e.to_node_id,e.citation_ref,e.underlying_msr_signal_ids_array
  ...
  WHERE e.chart_id='482012f1-710e-4a25-994a-93821f5871aa'
    AND (e.from_node_id='f04893fd-d9b0-407f-a5dc-b48a9360dba7'::uuid OR e.to_node_id='f04893fd-d9b0-407f-a5dc-b48a9360dba7'::uuid))
...
Node existence CONFIRMED in bodha_cgm_nodes (node_type='bhava', node_subject='4').
...
## Findings
[F1] class=1 UNREACHABLE (severity=high). Bhava-4 node is fully isolated: 0 edges.
