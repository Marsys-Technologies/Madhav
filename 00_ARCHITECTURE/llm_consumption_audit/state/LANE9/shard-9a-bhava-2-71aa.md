# Lane 9a STRUCTURAL shard — bhava:2:71aa

node_key: bhava:2:71aa
node_id: 5a38e9f4-c9f6-4c69-8089-173c0f469c33
...
WITH nbr AS (SELECT e.edge_id,e.edge_type,e.from_node_id,e.to_node_id,e.citation_ref,e.underlying_msr_signal_ids_array
  ...
  WHERE e.chart_id='482012f1-710e-4a25-994a-93821f5871aa'
    AND (e.from_node_id='5a38e9f4-c9f6-4c69-8089-173c0f469c33'::uuid OR e.to_node_id='5a38e9f4-c9f6-4c69-8089-173c0f469c33'::uuid))
...
Node existence CONFIRMED in bodha_cgm_nodes (node_type='bhava', node_subject='2').
...
## Findings
[F1] class=1 UNREACHABLE (severity=high). Bhava-2 node is fully isolated: 0 edges.
