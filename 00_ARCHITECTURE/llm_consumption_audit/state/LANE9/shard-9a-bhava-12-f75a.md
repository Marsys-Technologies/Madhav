# Lane 9a STRUCTURAL shard — node_key `bhava:12:f75a`

- node_id: `7b290bb1-4f11-473d-ba49-af9ff09c312e`
- node_type: `bhava`  node_subject: `12`
...
WITH nbr AS (
  ...
  WHERE e.chart_id='1c826d5a-41cb-4450-b4dc-59d440e5f75a'
    AND (e.from_node_id='7b290bb1-4f11-473d-ba49-af9ff09c312e' OR e.to_node_id='7b290bb1-4f11-473d-ba49-af9ff09c312e'))
...
node 7b290bb1-4f11-473d-ba49-af9ff09c312e exists in bodha_cgm_nodes  ->  1 (chart …f75a, node_type=bhava, node_subject=12)
edges touching 7b290bb1-4f11-473d-ba49-af9ff09c312e (any chart)      ->  0
```
...
- summary: bhava `12` exists as a first-class CGM node but participates in ZERO edges; no dispositor / lordship / yoga / temporal relationship is reachable from or to it via graph walk.
