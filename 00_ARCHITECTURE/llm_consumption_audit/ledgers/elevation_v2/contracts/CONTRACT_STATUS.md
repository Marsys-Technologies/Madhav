...
| C4 | house/sign convention (1–12 from varga-appropriate lagna; `house_*` never holds a sign index) | FROZEN | β (elev/beta) | contracts/C4_HOUSE_SIGN_CONVENTION_v1_0.md | `073b1461f058aadd3db5ba940742b0578ac64eda8abf882d3ee8a1dfcc3ba742` | T0+3h |
| C5 | sidereal ephemeris — `ayanamsha_id` param (default `lahiri_chitrapaksha`) + sidereal response shape | FROZEN | β (elev/beta) | contracts/C5_SIDEREAL_EPHEMERIS_v1_0.md | `448f8a05803e8c9864c4c4e39c09557ce73d8ea6b7423625ef3649337014163c` | T0+3h (published ~1h late — session reconnects, not a design difficulty — see proxy/beta.md) |
...
| C7 | accounting invariant (Ω3 completeness contract, CI-assertable form) | FROZEN | γ (elev/gamma) | contracts/C7_ACCOUNTING_INVARIANT_v1_0.md | `616e4f69dcf5000266655d4704860981be89767ecaef9fa48d15cbfd3d0592c4` | T0+4h (published ~2.5-3h late — see PROXY-RULED-002, proxy/gamma.md) |
