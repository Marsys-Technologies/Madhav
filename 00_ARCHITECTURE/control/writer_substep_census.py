...
out = {'unresolved_registrations': unresolved_registrations, 'files_scanned': files_scanned, 'parse_errors': parse_errors,
...
print(f'files_scanned={files_scanned} parse_errors={len(parse_errors)} registrations={len(registrations)} distinct_asset_ids={len(results)} dupes={list(dupes)}')
