...
MERGED, Rung P4 GREEN** (`25e7b9ede` on `pratijna-v4/integration`). **Lane B2 (the v4 engine) is
the NEXT ACTION** — dispatch a fresh-worktree BUILDER per rails; this is "the big one" (Rung P5,
must reproduce Rung P3's hand-worked numbers exactly).
