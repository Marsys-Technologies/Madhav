...
window.TRACKER = {
  ...
  "lanes": {
    ...
    "G1-A": {
      ...
      "verifier_verdict": "Native decision (2026-08-20, explicit real-time authorization): dispatch a hardening round rather than merge-with-caveats or merge-as-is, given the subject matter. Hardening round dispatched addressing 7 CRITICAL + 6 HIGH findings compiled from all 4 reviews (see g1_a_review_findings for full detail). G1-G remains blocked pending this."
    },
    "G1-C": {
      "role_stage": "merged",
