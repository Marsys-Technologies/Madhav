...
last_updated: 2026-09-06 — C8 v2.3 cycle 112; closed F-B14 (PR #2133) — get_sensitive_degrees.ts never selected verification_pass_status, flattening 225 single + 50 pending_w3_verification + 60 two_pass_verified rows into one undifferentiated array; now discloses tier_breakdown/unverified_rows_in_page, no rows dropped
---
