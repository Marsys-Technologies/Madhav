...
last_updated: 2026-09-06 — C8 v2.3 cycle 113; closed F-C21 (PR #2136) — six serving surfaces (get_strength/get_argala/get_ashtakavarga/get_dignity/get_avasthas/get_condition_composite) declared 0 occurrences of density_contract; all 6 now declare it honestly (empty_reason:true only where a real detector exists)
---
