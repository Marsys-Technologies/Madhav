...
| `platform/python-sidecar/routers/ephemeris.py` | Add producer-owned service context/fail-closed convention metadata without changing calculation. | Revert response metadata/validation. |
