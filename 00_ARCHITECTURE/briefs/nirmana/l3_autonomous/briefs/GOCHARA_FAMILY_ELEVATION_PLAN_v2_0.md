...
| 4 | **Schema** — migrations ≥1071: `kala_gochara_contacts`, `kala_gochara_coverage`, `kala_gochara_publication`, `gochara_resonance_map.target_resolution_state`; both migration directories checked; applied-state verified, never assumed (§N.4) | `information_schema` diff | down-migrations included |
