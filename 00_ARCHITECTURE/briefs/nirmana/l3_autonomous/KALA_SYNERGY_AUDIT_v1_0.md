...
**Re-citation state, 2026-09-24 (v1.7).** The L0 repair (PR #2727) re-cited `bg_transit_rules` in
**production**, verified live by this session and independently re-counted by the Gochara stream's
O-3 session: **42** favourable vedha rows, **0** citing BPHS Ch.29. One nuance the recount's headline
...
construction" claim to *unverified*, consistent with this audit's third correction on that asset.
