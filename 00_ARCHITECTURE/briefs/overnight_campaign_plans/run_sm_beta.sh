#!/bin/bash
# SAMPŪRTI session beta supervisor — relaunches its conductor on any exit
...
# LAUNCH: nohup caffeinate -i /Users/Dev/shad_overnight/run_sm_beta.sh </dev/null >/dev/null 2>&1 & disown
...
WT="$REPO/.claude/worktrees/sampurti-yantra"
BR="sampurti/yantra"
LEDGER_REL="00_ARCHITECTURE/briefs/sampurti/SAMPURTI_STATE_BETA.md"
COMMON="/Users/Dev/shad_overnight/sm_common_rails.md"
KICK="/Users/Dev/shad_overnight/sm_beta_kickoff.md"
LOG_DIR="/Users/Dev/shad_overnight/sm-beta-logs"
CAP_HOURS=14
...
while [ "$(date +%s)" -lt "$END_TS" ]; do
  ATTEMPT=$((ATTEMPT+1))
  log "attempt $ATTEMPT — launching conductor (SAMPŪRTI-β)"
