#!/bin/bash
# SAMPŪRTI session alpha supervisor — relaunches its conductor on any exit
...
# LAUNCH: nohup caffeinate -i /Users/Dev/shad_overnight/run_sm_alpha.sh </dev/null >/dev/null 2>&1 & disown
...
KICK="/Users/Dev/shad_overnight/sm_alpha_kickoff.md"
LOG_DIR="/Users/Dev/shad_overnight/sm-alpha-logs"
CAP_HOURS=14
...
while [ "$(date +%s)" -lt "$END_TS" ]; do
  ATTEMPT=$((ATTEMPT+1))
  log "attempt $ATTEMPT — launching conductor (SAMPŪRTI-α)"
