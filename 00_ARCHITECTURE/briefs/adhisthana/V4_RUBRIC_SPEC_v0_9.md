...
date: 2026-08-08
campaign: ADHIṢṬHĀNA, Lane A8 item 2 (checkpoint artifact 2 of 2)
author: Conductor (Sonnet 5), dispatched research/writing agent, document-only
rulings_governed: R11, R12, R13, R18
ratifies_at: the human+Fable design checkpoint (MASTER_PLAN_v1_0.md §4); becomes v1.0 there,
  not before
implements_nothing: this document specifies; it contains no engine code and authorizes none.
  Campaign B (PRATIJÑĀ v4 engine) is out of scope for the author of this document by direct
  instruction.
---
