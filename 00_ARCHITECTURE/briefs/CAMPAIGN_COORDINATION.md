...
| NIRMANA-ELEVATION-20260829-1 | NIRMĀṆA ELEVATION / Codex | Protected integration and release of PR #1656 only: migration 636 plus least-privilege immutable monitor-observation reads, normal merge queue and CI, deployment/migration verification, fresh exact release-sync observation, and one receipt-reconciled supersession attempt. No asset rebuild, L1+ work, credential change, protection bypass, or unrelated campaign mutation. | 2026-08-29 06:50 IST | 2026-08-29 09:50 IST | **ACTIVE** (supersedes expired NIRMANA-ELEVATION-20260826-1/-2; release immediately after the bounded release/supersession lane) |
