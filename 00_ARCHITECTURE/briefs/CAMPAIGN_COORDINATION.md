...
|---|---|---|---|---|---|
| MADHAV-PURNA-DELIVERY-SERVING-USAGE-SUCCESSOR-20260919 | PŪRṆA ANVEṢAṆA / Codex | **Serving-schema successor lease bound only to protected `main` `ee1b9f22390a086ebb46b38ca6e48b912defbf56` (PR #2688).** The predecessor automatic run `35450010050` proved the orchestration repair: DB inspection and routine migration succeeded with protected bootstrap skipped, then web/MCP/pipeline all entered delivery rather than being skipped. The web zero-traffic candidate built and passed basic smoke but failed the non-vacuous Pūrṇa database canary with PostgreSQL `42883`; it was not promoted. Direct production diagnosis proved `role_web_serve` and its sole child `amjis_inquiry_serve` lacked public-schema USAGE, so existing function EXECUTE grants were unresolvable. MCP remained no-traffic; pipeline image delivery completed; the doomed remainder was force-cancelled. PR #2688 makes USAGE-only (never CREATE) serving visibility canonical in cutover/status, makes Pūrṇa marked-state reject missing schema visibility, and adds a bounded deployment-only repair through the existing `data_plane_migrator -> data_plane_schema_owner` edge; focused tests passed 66/66 and protected/merge-group checks passed. The predecessor dd82-bound lease self-terminated on its failed exact-main deploy. This lease owns only: execute the exact merged USAGE-only repair once; re-attest strict data-plane plus marked Nirmāṇa/Pūrṇa state; observe exact-main CI/automatic outcome; one exact force-all dispatch; web/MCP/sidecar/pipeline candidate smoke/promotion; actual ready revision, traffic, deployed SHA, pipeline image, migration 1040/1041, bootstrap-absence and bounded regression proof; migration-barrier decision, campaign events and release. Preserve all migrations and data, strict ownership/isolation, absence of one-shot Pūrṇa authority, L3/Kāla, retired `ka_gochara_sweep`, WriterBase and L4/L5 holds. No privileged bootstrap recreation, ruleset bypass, broad IAM, CREATE grant, owner membership, destructive rebuild, feature work, secret disclosure or empirical/product-acceptance claim. Stop on tip drift, repair/attestation failure, failed exact-main CI/deploy/smoke, rollback ambiguity or unexpected impact. | 2026-09-19 22:42 IST | 2026-09-20 01:30 IST | **ACTIVE — EXACT-MERGED USAGE-ONLY REPAIR, FORCE-ALL SERVICE PROOF, BARRIER DECISION AND RELEASE** |
