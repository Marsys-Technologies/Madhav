...
| 1039 | PURNA-ANVESANA / Codex | `1039_fresh_replay_classical_compat.sql` (fresh-replay bridge for incompatible historical classical schema generations) | **RELEASED UNUSED** — bounded rehearsal proved this would require an estate-wide canonical-baseline redesign beyond the Pūrṇa release scope; no 1039 file was committed or pushed; number is free to be reallocated after a fresh allocator read |
