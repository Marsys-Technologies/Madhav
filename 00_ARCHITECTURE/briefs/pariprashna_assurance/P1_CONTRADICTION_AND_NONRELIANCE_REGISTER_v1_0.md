# P1 contradiction, uncertainty, and non-reliance register v1.0

| ID | Classification | Matter | Required handling |
| --- | --- | --- | --- |
| P1-U-001 | DO_NOT_RELY | Historical prose moved through 56/76 and 53/77 obligation snapshots. | Use latest-record derivation: 77 records, 53 active. |
| P1-U-002 | DO_NOT_RELY | EDIR claims ledger has 83 latest IDs while EDIR register has 115 findings. | Treat claims as allocation/audit only. |
| P1-U-003 | SUPERSEDED | Stand-down “P0–P2 VERIFIED” lane language. | It does not authorize resumption or campaign completion. |
