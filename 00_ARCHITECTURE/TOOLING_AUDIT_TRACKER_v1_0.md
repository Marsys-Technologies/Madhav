...
| D4 | school_convergence_index all silent | 2.1 | OPEN | 574 rows exist (one per MSR signal). SCHEMA DIFFERS FROM PLAN: columns are signal_id, parashari_present, jaimini_present, kp_present, tajika_present, convergence_score, missing_schools (NOT school×coverage_type). Coverage: parashari=499/574, jaimini=546/574, kp=459/574, tajika=484/574. Data exists but cross_school_lookup wrapper (C3) fails to pass the claim through. |
