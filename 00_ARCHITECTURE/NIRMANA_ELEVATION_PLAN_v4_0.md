...
### L0 · Brahmagyan — 40 assets · 9 non-conformant · 6 P0 · 0 heavy
...
#### `bg_ephemeris_engine` — S · Service probe · P0 · Blocking defect · CURRENT
...
| Re-architecture & alignment | • Collapse `asset_type`/`asset_kind`/`storage_type` to one authoritative `asset_kind` (Phase 0.6b).<br>• Keep out of per-chart plans but expose completion to the per-chart readiness gate uniformly (the migration-563 class of bug, made structural).<br>• Move to the service lane with `health_probe` + `provides_apis`; `count_sql` must be null. |
| Expected benefit | • A degraded service surfaces in minutes, not months (one sat red for 66 days). |

#### `bg_muhurta_lattice` — G · Global substrate · P0 · Blocking defect · CURRENT
...
#### `bg_panchanga` — S · Service probe · P0 · Blocking defect · CURRENT
...
### L1 · Gaṇita — 19 assets · 8 non-conformant · 6 P0 · 5 heavy
...
#### `ga_ayurdaya` — M · Medium deterministic · P0 · Blocking defect · CURRENT
...
#### `ga_nakshatra` — M · Medium deterministic · P0 · Blocking defect · CURRENT
...
#### `ga_sensitive` — H · Heavy partitioned · P0 · Blocking defect · CURRENT
...
#### `ga_sensitive_degree` — M · Medium deterministic · P0 · Blocking defect · CURRENT
...
#### `ga_structural` — M · Medium deterministic · P0 · Blocking defect · CURRENT
...
### L2 · Bodha — 22 assets · 14 non-conformant · 13 P0 · 3 heavy
...
#### `bo_laksana` — H · Heavy partitioned · P0 · Blocking defect · CURRENT
...
#### `bo_samskara` — H · Heavy partitioned · P0 · Blocking defect · CURRENT
...
### L3 · Kāla — 23 assets · 12 non-conformant · 10 P0 · 2 heavy
...
#### `ka_graha_sancara` — S · Service probe · P0 · Blocking defect · DRAFT
...
#### `ka_muhurta_seva` — S · Service probe · P0 · Blocking defect · DRAFT
...
### L5 · Mīmāṃsā — 15 assets · 11 non-conformant · 11 P0 · 0 heavy
...
| Correctness & completeness | • Real liveness + correctness probe with an SLO (not just "responds"): exercise one known-answer query and compare against a pinned expected value; alert on drift or timeout. |
| Rebuild time | • Not a build; nothing to speed up. Exclude from build plans and ETA math. |
| Re-architecture & alignment | • Collapse `asset_type`/`asset_kind`/`storage_type` to one authoritative `asset_kind` (Phase 0.6b).<br>• Promote to CURRENT or record why it remains DRAFT (Phase 0.8b) — it is built and read by 1 serving surface(s), so it is authoritative in practice.<br>• Move to the service lane with `health_probe` + `provides_apis`; `count_sql` must be null. |
| Expected benefit | • A degraded service surfaces in minutes, not months (one sat red for 66 days). |
...
#### `mi_seva` — S · Service probe · P0 · Blocking defect · DRAFT
...
| Correctness & completeness | • Real liveness + correctness probe with an SLO (not just "responds"): exercise one known-answer query and compare against a pinned expected value; alert on drift or timeout. |
| Rebuild time | • Not a build; nothing to speed up. Exclude from build plans and ETA math. |
| Re-architecture & alignment | • Collapse `asset_type`/`asset_kind`/`storage_type` to one authoritative `asset_kind` (Phase 0.6b).<br>• Move to the service lane with `health_probe` + `provides_apis`; `count_sql` must be null. |
| Expected benefit | • A degraded service surfaces in minutes, not months (one sat red for 66 days). |
