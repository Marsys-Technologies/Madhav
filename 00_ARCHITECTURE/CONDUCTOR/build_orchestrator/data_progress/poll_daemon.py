...
ASSET_REGISTRY = {
    # ── Layer L1 — Raw Facts ─────────────────────────────────────────────────
    "A1":  {"layer": "L1", "name": "Pratyaksha · Direct Perception (Engine)",
    ...
    "A4":  {"layer": "L1", "name": "Panchanga · Five Limbs of Time",
    ...
    "A5":  {"layer": "L1", "name": "Marma-Bindu · Key Pressure Points",
    ...
    "A6":  {"layer": "L1", "name": "Shodashvarga · The Sixteen Mirrors",
    ...
    "A7":  {"layer": "L1", "name": "Dasha-Kala · Time Lords",
    ...
    "A8":  {"layer": "L1", "name": "Bala-Yoga · Strengths & Patterns",
    ...
    "A9":  {"layer": "L1", "name": "Sade-Sati · Saturn's Long Walk",
    ...
    "A17": {"layer": "L1", "name": "Yantra · Sacred Geometries",
    ...
    "A19": {"layer": "L1", "name": "Bhrigu-Bindu · Lifetime Hits",
    ...
    "A20": {"layer": "L1", "name": "Varshesha · Annual Lords",
    ...
    "A21": {"layer": "L1", "name": "Drishti-Patrika · Aspect Calendar",
    ...
    "A10": {"layer": "L2.5", "name": "Lakshana-Sangraha · The Signal Catalog",
    ...
    "A11": {"layer": "L2.5", "name": "Bhava-Sambandha · Life-Domain Linkages",
    ...
    "A12": {"layer": "L2.5", "name": "Chakra-Jala · The Chart Web",
    ...
    "A13": {"layer": "L2.5", "name": "Aushadhi · The Remedies",
    ...
    "A14": {"layer": "L2.5", "name": "(Retired)", "retired": True,
    ...
    "A15": {"layer": "L2.5", "name": "Sangat-Kala · Convergence Windows",
    ...
    "A16": {"layer": "L2.5", "name": "Sankalpa-Phala · Predicted Events",
    ...
    "A18": {"layer": "L2.5", "name": "Vedha · Obstructions",
            ...
            "expected_per_ayanamsha": 1000, "expected_per_chart": 5000},
    "A22": {"layer": "L2.5", "name": "Varsha-Darshan · Yearly Vision",
    ...
    "META_ALPHA": {"layer": "L3", "name": "Trikala-Darshan · Vision of Three Times",
    ...
    "META_BETA": {"layer": "L3", "name": "Yantra-Sangraha · Pattern Atlas",
            ...
            "expected_per_ayanamsha": 150, "expected_per_chart": 750},
    "META_GAMMA": {"layer": "L3", "name": "Sampradaya · Schools Speak",
    ...
    "META_DELTA": {"layer": "L3", "name": "Shunya · The Empty",
    ...
    "META_EPSILON": {"layer": "L3", "name": "Pramana · Evidence Trail",
    ...
    "META_ZETA": {"layer": "L3", "name": "Kala-Darpana · Time Mirror",
