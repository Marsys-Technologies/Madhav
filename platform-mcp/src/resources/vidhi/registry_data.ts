...
export const VIDHI_PRIMITIVES: readonly VidhiPrimitive[] = [
  ...
  },
  {
    ...
    fallback_face: 'query_special_lagnas',
  ...
  },
  {
    ...
    category: 'temporal',
    live_tool: 'kala_temporal_bundle',
  ...
  },
  {
    ...
    tool_args: { chart_id: '{chart_id}' },
    fallback_face: 'yoga_activation_by_dasha',
  ...
  },
  {
    ...
    fallback_face: 'query_planet_transit',
    known_gap: null,
    mandatory_tags: [],
    cr27_prevents: [],
  },
  ...
  },
  {
    ...
    category: 'remedy',
    live_tool: 'bodha_remedies_search',
    tool_args: { chart_id: '{chart_id}', domain: '{domain}' },
    fallback_face: 'query_remedies_for_chart',
