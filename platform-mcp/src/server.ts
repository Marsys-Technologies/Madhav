...
import { registerConcordanceLookupTool } from './tools/concordance_lookup.js'
...
app.post('/mcp', async (req: Request, res: Response) => {
  ...
  // Layer-0 Brahmagyan tools (BG-0-7 Concordance)
  registerConcordanceLookupTool(server)
...
app.listen(port, () => {
  console.log(`[mcp:server] MARSYS-JIS MCP server listening on :${port} (1 tool: concordance_lookup [BG-0-7])`)
