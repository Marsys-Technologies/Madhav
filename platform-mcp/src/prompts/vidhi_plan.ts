        ...
        messages: [
          {
            ...
            content: {
              ...
              text: [
                ...
                darkLines,
                '',
                'This prompt is a planning scaffold, not completion proof. For a server-canonical',
                'receipt use inquiry_start, execute only the signed next actions through',
                'inquiry_execute_next, then call inquiry_finalize. Caller-authored served/empty',
                'observations are deliberately rejected; paginated reads remain incomplete until',
                'the server records an exhaustion marker.',
