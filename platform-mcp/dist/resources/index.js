...
export function registerResources(server) {
    ...
    server.resource('chart-overview', new ResourceTemplate('marsys://chart-overview', { list: undefined }), async (_uri) => ({
        contents: [
            {
    ...
    server.resource('house-rules', new ResourceTemplate('marsys://house-rules', { list: undefined }), async (_uri) => ({
        contents: [
            {
