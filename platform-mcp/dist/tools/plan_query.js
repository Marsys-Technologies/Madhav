 ...
 */
export function registerPlanQuery(server, getPrincipal) {
    // PLACEHOLDER description — full §4.6 description lands in MCP-2-S2.
    const placeholderDescription = 'Returns the PipelinePlan JSON for the query without executing it. ' +
        'Inspect what tools would run before committing to execution. [Full ' +
        'description: MCP-2-S2]';
    server.tool('plan_query', placeholderDescription, PlanQueryInputSchema.shape, async (args) => {
...
//# sourceMappingURL=plan_query.js.map