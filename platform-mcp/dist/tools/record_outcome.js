 ...
 */
export function registerRecordOutcome(server, getPrincipal) {
    server.tool('record_outcome', 'Record an observed outcome against a prior PPL prediction (by prediction_id). ' +
        ...
        'Returns found=true if prediction_id exists in PPL; found=false if not.', RecordOutcomeInputSchema.shape, async (input) => {
        const principal = getPrincipal();
        const result = await callPlatformWrites('record_outcome', {
            entry: {
...
//# sourceMappingURL=record_outcome.js.map