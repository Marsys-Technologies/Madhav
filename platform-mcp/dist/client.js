...
function buildClientErrorEnvelope(message, errorClass = 'internal') {
    return {
        ok: false,
        trace_id: '',
        error: {
 ...
 */
export async function callPlatform(toolCall, principal) {
 ...
 */
export async function callPlatformPlan(query, principal) {
    const identityToken = await fetchIdentityToken();
 ...
 * @returns         The HTTP status code and parsed McpEnvelope.
 */
export async function callPlatformPrimitive(toolName, params, principal) {
    const identityToken = await fetchIdentityToken();
    return platformFetch({
 ...
 * @returns         The HTTP status code and parsed McpEnvelope.
 */
export async function callPlatformAsset(params, principal) {
    const identityToken = await fetchIdentityToken();
    return platformFetch({
 ...
 * @returns         The HTTP status code and parsed McpEnvelope.
 */
export async function callPlatformTrace(traceId, principal) {
    const identityToken = await fetchIdentityToken();
 ...
 * @returns         The HTTP status code and parsed McpEnvelope.
 */
export async function callPlatformWrites(action, params, principal) {
    const identityToken = await fetchIdentityToken();
    return platformFetch({
 ...
 * @returns         The HTTP status code and parsed McpEnvelope.
 */
export async function callPlatformRecent(params, principal) {
    const identityToken = await fetchIdentityToken();
