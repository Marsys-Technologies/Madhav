...
const snapshot = {
  schema_version: '2.1.0', compatibility_version: 'planner-scu-v2', generated_at: '2026-09-13T00:00:00.000Z',
  ...
  census: { runtime_descriptors: 1, addressable_descriptors: 1, excluded_descriptors: 0, semantic_capabilities: 1, editorial_scus: 1, derived_scus: 0, executable_bindings: 1, unavailable_bindings: 0, publicly_named_bindings: 0, reviewed_pagination_bindings: 0, producer_output_claims: 1, reviewed_output_claims: 1, typed_concepts: 0, unbound_concepts: 0, isolated_scus: 1, graph_components: 1, dispositioned_isolated_scus: 1, unresolved_isolated_scus: 0, producer_semantic_bindings: 0, directly_served_producer_outputs: 0, support_only_producer_bindings: 0, unbound_active_producers: 0, undispositioned_producer_scus: 0, undispositioned_gaps: 0, exclusions: [] },
  scus: [{
