...
export const judgmentQueryCapability: CapabilityDescriptor = {
  ...
  description: [
    ...
    'that is L4/L5\'s job) · a versioned `judgment-reading-checklist-v2` completeness receipt',
    '(design §28.6). The receipt names every required classical unit, including bearing yogas,',
    'bearing afflictions, corroborating vargas, Ashtakavarga, special lagnas, yogi/avayogi,',
