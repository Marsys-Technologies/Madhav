...
import { CostCapTracker, resolveCostCapsForEntitlement, DEFAULT_COST_CAPS } from '@/lib/pipeline/cost_caps'
...
describe('resolveCostCapsForEntitlement', () => {
  it('returns the default caps for the base full-loop entitlement tier (guest)', () => {
