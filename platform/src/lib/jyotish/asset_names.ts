...
export const ASSET_NAMES = {
  ...
  bg_class_priors:      { sanskrit: 'Pūrva-pakṣa-mānāḥ', english: 'Class Priors',   subtitle: '171-row ranked salience prior matrix: class × subsystem × tradition × varga × graha×domain', layer: 'L0' },
