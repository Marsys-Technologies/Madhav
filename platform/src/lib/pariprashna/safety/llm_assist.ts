 ...
 *
 * ── HOW THE GUARANTEE IS STRUCTURAL, NOT PROMISED ────────────────────────────
 ...
 * There is no parameter, field, or code path by which an assist payload can
 * cause the output to carry fewer classes or a lower severity than the input.
...
/**
 * What an LLM assist is permitted to say. Note what this interface CANNOT
 * express: there is no "clear", "downgrade", "override", or "confidence" field.
 * The only inputs are additive.
 */
