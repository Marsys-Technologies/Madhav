...
const LIVE_TOOLS = new Set<string>([
  ...
  'get_temporal_windows', 'graha_portrait', 'holistic_bundle_chart_facts', 'intent_classify',
  'judgment_query', 'kala_life_arc_get', 'kala_muhurta_get', 'kala_priority_ranking_get',
  'kala_projections_get', 'kala_temporal_bundle', 'kala_windows_get', 'kala_yoga_activation_get',
  'lel_query', 'list_assets', 'list_entities', 'list_my_charts', 'list_my_sessions',
  ...
  'query_tantric_remedies', 'read_remedy', 'recall_session', 'record_outcome',
  ...
  'resolve_entity', 'select_chart', 'synth_chart_brief_get', 'synth_tail_divergence_get',
