...
const WEALTH_DEEPDIVE_ITEMS: readonly FloorItem[] = [
  ...
  { primitive_id: 'cross_ayanamsha_variation', order: 21, band: 'acharya_floor', args_override: { point: 'JUPITER' } },
  ...
  { primitive_id: 'intervention_synthesis', order: 24, band: 'machine_band', args_override: { domain: 'wealth' } },
  // E-1/E-2/E-5/E-6/E-7 shared elevation tail (domain=wealth; orders 25-33).
  ...elevationTail('wealth', 25),
];
