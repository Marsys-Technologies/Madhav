...
describe('RT-04 — Primitive whitelist enforcement', () => {
  ...
  it('RT-04h: whitelist maps 47 entries (11 original + 4 MCP TR + 4 retrieval aliases + 4 stubs + 14 UDA + 2 entity + 7 remedy + 1 mitigation)', () => {
    expect(Object.keys(MCP_TO_RETRIEVAL_TOOL)).toHaveLength(47)
  })
