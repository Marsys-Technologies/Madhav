...
/**
 * Converts house display format "DD-MMM-YYYY" (e.g. "05-Feb-1984") to
 * "YYYY-MM-DD". Accepts either "-" or " " as separator.
...
export function parseBirthDateDisplay(raw: string): string | null {
  ...
  if (!month || isNaN(day) || isNaN(year) || day < 1 || day > 31 || year < 1) return null
