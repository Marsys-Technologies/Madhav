...
// Phase 4C — MoonCrescent icon for /panchang nav entry
function MoonCrescentIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg
  ...
  return (
    ...
    >
      ...
      >
        ...
        {expanded && (
          <span className="truncate font-serif text-[13px] font-medium leading-none" style={{ color: 'var(--brand-gold-cream)' }}>
            MARSYS-JIS
          </span>
        )}
      </Link>
