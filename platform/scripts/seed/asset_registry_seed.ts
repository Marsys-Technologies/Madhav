...
const ASSETS: AssetDef[] = [
  ...
  },
  {
    ...
    expected_volume_formula: null,
    expected_volume_inputs: null,
    volume_explanation: '41 classical gochara transit rules per actual build count.',
    depends_on: [],
    scope: 'global', is_active: true, estimated_seconds: null,
  },
  {
...
`,
  ...
  },
  {
    ...
    expected_volume_formula: null,
    expected_volume_inputs: null,
    volume_explanation: 'Domain-pair × snapshot_type cells; count depends on distinct domain pairs with active signals',
    depends_on: ['bo_laksana'],
    scope: 'per_chart', is_active: true, estimated_seconds: null,
  },
  {
  ...
  },
  {
    ...
    depends_on: ['ka_kalasutra', 'ga_sensitive'],
    scope: 'per_chart', is_active: true, estimated_seconds: null,
  },
  {
  ...
  // ── PHALA (5) ─────────────────────────────────────────────────────────────
  {
    ...
    target_floor: null,
    expected_volume_formula: 'ACTUAL(ka_sangam) * ANCHOR_PER_CONVERGENCE',
    expected_volume_inputs: null,
  ...
  },
  {
    ...
    depends_on: ['ka_kalasutra', 'ga_panchanga'],
    scope: 'per_chart', is_active: true, estimated_seconds: null,
  },
  {
    asset_id: 'ph_sodhana',
  ...
  },
  {
    ...
    depends_on: ['bo_upaya', 'ka_vighnakara'],
    scope: 'per_chart', is_active: true, estimated_seconds: null,
  },
  {
  ...
  },
  {
    ...
    depends_on: ['bo_laksana', 'ka_kalasutra'],
    scope: 'per_chart', is_active: true, estimated_seconds: null,
  },
  {
    asset_id: 'mi_pramana',
