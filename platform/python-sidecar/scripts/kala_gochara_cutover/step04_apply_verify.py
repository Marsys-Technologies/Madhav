...
Applies this run's migrations — 1080 through 1086 in `platform/migrations/`
(renumbered pair per ESCALATIONS.md E-007 addendum; the brief text's
"1075/1076" is the pre-renumber label for 1080/1081) — to the target database,
...
1085's DOWN block is exercised by test_g9_vedha_row_repair.py).
...
# The migrations this cutover applies, in order. 1080–1086 (this run).
APPLY_SET = [
