"""
tests/test_migration_848_dasha_kala_proxy_probe.py — L3 Kāla, F-L3-15 fourth
and final slice: migration 848 (renumbered four times, 811->841->844->847->848 -- see the
...
_MIGRATION_PATH = os.path.join(
    _REPO_ROOT, "platform", "migrations", "848_nirmana_l3_w3_dasha_kala_proxy_probe.sql"
)
