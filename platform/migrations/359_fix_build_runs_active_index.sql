...
CREATE INDEX IF NOT EXISTS build_runs_chart_state_planned_idx
...
CREATE INDEX IF NOT EXISTS bodha_msr_signals_chart_computed_idx
  ON bodha_msr_signals (chart_id, computed_at DESC);

CREATE INDEX IF NOT EXISTS chart_facts_chart_computed_idx
