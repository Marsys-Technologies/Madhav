...
--
-- bo_vargottama_dhana writes to the SHARED table bodha_msr_signals, scoped
-- to its own declared slice -- but unlike its three siblings, it emits under
-- TWO signal_type_class values, not one:
-- VARGOTTAMA_AMPLIFICATION_SIGNAL_TYPE_CLASS = "vargottama_amplification"
-- and DHANA_AXIS_SIGNAL_TYPE_CLASS = "dhana_axis" (both declared in
-- platform/python-sidecar/bodha_writers/vargottama_dhana_emitter.py:52,56).
-- The where_in list is both values, sorted ascending per output_digest.py's
