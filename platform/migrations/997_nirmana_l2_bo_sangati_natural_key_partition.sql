-- 997_nirmana_l2_bo_sangati_natural_key_partition.sql
--
-- NIRMANA v2.5 -- L2 (Bodha). Transaction ownership belongs to
-- platform/scripts/migrate.ts.
--
-- Renumbered from 991 -> 997 alongside its sibling (990 -> 996) to escape a
-- cross-lane migration-number race with PR #2506 (L1, mi_bhavisya, also
-- 990/991) and PR #2509 (L1, mi_pramana, 994/995) -- see 996's header for
-- the full account.
--
-- Sibling migration to 996 (bo_sangati output_digest_spec) -- see that
