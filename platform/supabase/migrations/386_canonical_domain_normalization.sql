...
-- ── 1. Data normalization: bodha_msr_signals.domains_affected_array ──────────
...
-- ── 2. Data normalization: phala_anchors.domain ───────────────────────────────
...
-- ── 3. Data normalization: phala_phaladesa.domain ────────────────────────────
...
-- ── 4. Data normalization: ka_bhavishya_lekha.domain ─────────────────────────
...
-- ── 5. Data normalization: phala_sankrama.target_domain ──────────────────────
...
-- ── 6. Data normalization: school_analysis_runs / convergence_scores (UPPERCASE) ─
...
-- UPPERCASE 'SPIRITUAL' → 'spirituality', 'PSYCHOLOGICAL' → 'character'
...
-- ── 7. Schema: drop legacy CHECK constraints and add canonical ones ───────────
