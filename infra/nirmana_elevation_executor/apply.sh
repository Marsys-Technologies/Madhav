#!/usr/bin/env bash
# Dedicated IaC wrapper for the Nirmana elevation executor/verifier identities.
# A reviewed GCP-native release may apply only the exact saved plan it produced.
# Mirrors infra/nirmana_elevation_monitor/apply.sh verbatim except for the
# state prefix; see that root's README for the full apply discipline this
# wrapper enforces.
...
STATE_PREFIX="nirmana-elevation-executor"
